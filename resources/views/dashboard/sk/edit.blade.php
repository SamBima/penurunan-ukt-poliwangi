...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit SK Penurunan UKT</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Edit SK</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('sk.update', $sk->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('tahun') is-invalid @enderror"
                                   id="tahun" name="tahun" value="{{ old('tahun', $sk->tahun) }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tanggal_terbit') is-invalid @enderror"
                                   ...
                                   value="{{ old('tanggal_terbit', $sk->tanggal_terbit->format('Y-m-d')) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('judul') is-invalid @enderror"
                           id="judul" name="judul" value="{{ old('judul', $sk->judul) }}"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror"
                              ...
                              placeholder="Keterangan tambahan (opsional)">{{ old('keterangan', $sk->keterangan) }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="mb-2">
                        <small class="text-muted">File saat ini:
                            <a href="{{ route('sk.download', $sk->id) }}" target="_blank">
                                {{ $sk->nomor_sk }}.pdf
                            </a>
                        </small>
                    </div>
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="file">Pilih file baru (kosongkan jika tidak ingin mengubah)...</label>
                        @error('file')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
