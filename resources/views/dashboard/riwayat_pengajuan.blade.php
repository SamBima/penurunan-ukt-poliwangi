                            ...
                            @endphp
                             ...
                             @if($isDitolak)
                                 <div class="alert alert-danger mb-0">
                                     ...
                                     <div class="p-3 bg-white text-dark rounded border border-danger shadow-sm mt-3">
                                         <span class="font-weight-bold text-danger d-block mb-1">
                                             <i class="fas fa-exclamation-triangle"></i> Alasan Penolakan:
                                         </span>
                                         <p class="mb-0 text-dark font-weight-normal" style="white-space: pre-line;">{{ $pengajuan->alasan_penolakan ?? ($pengajuan->hasilValidasi->first()->catatan ?? 'Pengajuan Anda tidak dapat diproses lebih lanjut.') }}</p>
                                     </div>
                                 </div>
                             @else
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    ...
                                    <div class="bg-light p-3 rounded mb-3">{{ $pengajuan->alasan_pengajuan }}</div>

                                    @if($pengajuan->status === 'ditolak')
                                        <div class="alert alert-danger border-left-danger shadow-sm">
                                            <h6 class="font-weight-bold text-danger mb-1">
                                                <i class="fas fa-times-circle"></i> Catatan / Alasan Penolakan (Keuangan)
                                            </h6>
                                            <p class="mb-0 text-dark" style="white-space: pre-line;">{{ $pengajuan->alasan_penolakan ?? ($pengajuan->hasilValidasi->first()->catatan ?? 'Pengajuan Anda tidak dapat diproses lebih lanjut.') }}</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
