            ...
            <form action="{{ route('pengajuan') }}" method="POST" enctype="multipart/form-data" id="pengajuanForm">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-2">Upload dokumen pendukung sesuai kebutuhan.
                            <span class="text-danger">*</span> Wajib isi dokumen utama</p>
                        <ol class="text-muted mb-3 pl-3">
                            <li>Foto Rumah<span class="text-danger">*</span></li>
                            <li>Foto KK<span class="text-danger">*</span></li>
                            <li>Foto tagihan listrik<span class="text-danger">*</span></li>
                            <li>Foto Surat Pernyataan Dari Teman<span class="text-danger">*</span></li>
                            <li>Foto PBB<span class="text-danger">*</span></li>
                            <li>Foto tagihan PDAM</li>
                            <li>Foto Motor</li>
                            <li>Foto Mobil</li>
                            <li>Foto Kepemilikan Kartu Bantuan</li>
                        </ol>
                    </div>
