...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Hasil Validasi</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('list-pengajuan.validasi', $pengajuan->kode) }}" method="POST" id="validasiForm">
                        ...
                        {{-- <div class="form-group">
                            <label for="catatan"><strong>Catatan Validasi</strong></label>
                            <textarea class="form-control" id="catatan" name="catatan" rows="4"
                                placeholder="Berikan catatan hasil validasi..." required></textarea>
                        </div> --}}
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="hasil_wawancara" name="hasil_wawancara" rows="3"
                                placeholder="Rangkuman hasil wawancara..."></textarea>
                        </div>

                        <div class="form-group">
                            <label for="hasil_score"><strong>Skor Penilaian</strong></label>
                            <input type="number" class="form-control" id="hasil_score" name="hasil_score"
                                min="0" max="500" placeholder="0-500" required>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success btn-block">
                                <i class="fas fa-save"></i> Simpan Hasil Validasi
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="border-left-primary shadow-sm p-3 mb-3">
                        ...
                        <hr class="my-2">
                        {{-- <p class="mb-1"><strong>Catatan:</strong> {{ $validasi->catatan }}</p> --}}
...
document.addEventListener('DOMContentLoaded', function() {
    const uktSaatIni = '{{ $pengajuan->mahasiswa->ukt_awal ?? 0 }}';
    const rekomendasiSelect = document.getElementById('rekomendasi_ukt');
});
</script>
@endsection
