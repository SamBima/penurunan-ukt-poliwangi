    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            @php
                ...
                $sawCriteria = [
                    ['label'=>'Penghasilan Orang Tua', 'icon'=>'fa-money-bill-wave', 'nilai'=>(float)$pengajuan->total_gaji,          'min'=>$minGaji,       'max'=>$maxGaji,       'bobot'=>0.20, 'tipe'=>'cost',   'display'=>'Rp ' . number_format($pengajuan->total_gaji, 0, ',', '.')],
...
<script>
    ...
    const sawData = {
        totalGaji:       { nilai: {{ (float)$pengajuan->total_gaji }},        min: {{ $minGaji }},       max: {{ $maxGaji }},       bobot: 0.20, tipe: 'cost'    },
